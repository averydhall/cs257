...
function onPlayerInputChanged() {
    ...
    .then(function(player_stats) {
        ...
        if (player_stats.length != 0){
            tableBody += '<tr>'
                            + '<th style="position: sticky;">Year</th>'
                            //+ '<th>name</th>'
                            //+ '<th>position</th>'
                            + '<th style="position: fixed;>Age</th>'
                            + '<th style="position: sticky; top: 0;">Team</th>'
                            + '<th style="position: sticky; top: 0;">G</th>'
                            + '<th style="position: sticky; top: 0;">GS</th>'
                            + '<th style="position: sticky; top: 0;">MP</th>';

                            if (showBoxScoreStats.checked) {
                                tableBody += '<th style="position: sticky; top: 0;">FG</th>'
                                + '<th style="position: sticky; top: 0;">FGA</th>'
                                + '<th style="position: sticky; top: 0;">FG%</th>'
                                + '<th style="position: sticky; top: 0;">3P</th>'
                                + '<th style="position: sticky; top: 0;">3PA</th>'
                                + '<th style="position: sticky; top: 0;">3P%</th>'
                                + '<th style="position: sticky; top: 0;">2P</th>'
                                + '<th style="position: sticky; top: 0;">2PA</th>'
                                + '<th style="position: sticky; top: 0;">2P%</th>'
                                + '<th style="position: sticky; top: 0;">eFG%</th>'
                                + '<th style="position: sticky; top: 0;">FT</th>'
                                + '<th style="position: sticky; top: 0;">FTA</th>'
                                + '<th style="position: sticky; top: 0;">FT%</th>'
                                + '<th style="position: sticky; top: 0;">ORB</th>'
                                + '<th style="position: sticky; top: 0;">DRB</th>'
                                + '<th style="position: sticky; top: 0;">TRB</th>'
                                + '<th style="position: sticky; top: 0;">AST</th>'
                                + '<th style="position: sticky; top: 0;">STL</th>'
                                + '<th style="position: sticky; top: 0;">BLK</th>'
                                + '<th style="position: sticky; top: 0;">TOV</th>'
                                + '<th style="position: sticky; top: 0;">PF</th>'
                                + '<th style="position: sticky; top: 0;">PTS</th>'
                            }
                            if (showAdvancedStats.checked) {
                              tableBody += '<th style="position: sticky; top: 0;">PER</th>'
                              + '<th style="position: sticky; top: 0;">TS%</th>'
                              + '<th style="position: sticky; top: 0;">USG%</th>'
                              + '<th style="position: sticky; top: 0;">OWS</th>'
                              + '<th style="position: sticky; top: 0;">DWS</th>'
                              + '<th style="position: sticky; top: 0;">WS</th>'
                              + '<th style="position: sticky; top: 0;">WS_per_48</th>'
                              + '<th style="position: sticky; top: 0;">OBPM</th>'
                              + '<th style="position: sticky; top: 0;">DBPM</th>'
                              + '<th style="position: sticky; top: 0;">BPM</th>'
                              + '<th style="position: sticky; top: 0;">VORP</th>';
                            }
                            + '</tr>\n';
        }
        ...
        for (let k = 0; k < player_stats.length; k++) {
            ...
            tableBody += '<tr>'
                            //at some point we can add a link to player info page
                            + '<td style="position: sticky; left:0;">' + player_season['year'] + '</td>'
